  ...
  return (
    <body className="body">
        ...
        <div className="leveling">
          <div className="block2">
            ...
            <p className="p" id="background">
              ...
              realize I needed a new professional challenge and decided to focus
              more on what I love. Therefore I started to learn how to code.
              <br></br>
            </p>
          </div>
        </div>
      ...
      <footer className="footer" id="contacts">
        <a className="a" href="giuggey85@gmail.com">
          E-mail
        </a>
        <a className="a" href="https://github.com/Naryond/Naryond">
          Git Hub
        </a>
        <a
          className="a"
