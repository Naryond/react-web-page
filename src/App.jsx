    ...
    <div>
      ...
      <div className="personalInfo">
        <p>
          ...
          (U.K.). Born in Italy in 1985, I lived withing the country until 30
          y/o when I decided to change my live starting to study to become a
          Casino Dealer. Having had 10 years of experience in the Gambling
          Industry that was an easy step to make, and in 6 months I succesfully
          ...
          decided to focus more on what I love. Therefore I started to learn how
          to code.
        </p>
        <img
          className="img-size"
